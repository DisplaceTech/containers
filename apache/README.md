...
docker run -d -p 8080:80 ghcr.io/displace-technologies/apache:latest

# Run with custom content
docker run -d -p 8080:80 -v $(pwd)/html:/var/www/html ghcr.io/displace-technologies/apache:latest

# Run with SSL support
docker run -d -p 8080:80 -p 8443:443 \
  -v $(pwd)/certs:/etc/ssl/certs \
  -v $(pwd)/private:/etc/ssl/private \
  ghcr.io/displace-technologies/apache:latest
```
...
- `ghcr.io/displace-technologies/apache:latest` - Latest stable version
- `ghcr.io/displace-technologies/apache:2.4.65` - Specific Apache version
- `ghcr.io/displace-technologies/apache:2.4` - Apache 2.4 series
