...
```bash
# Build Apache 2.4
docker build -t ghcr.io/displace-technologies/apache:2.4.65 containers/apache/2.4/

# Build PHP-FPM 8.4
docker build -t ghcr.io/displace-technologies/php-fpm:8.4.13 containers/php-fpm/8.4/

# Build MariaDB 11.5
docker build -t ghcr.io/displace-technologies/mariadb:11.5 containers/mariadb/11.5/

# Build WordPress with PHP 8.4
docker build -t ghcr.io/displace-technologies/wordpress:6.8.3-php8.4 containers/wordpress/6.8.3-php8.4/
```
