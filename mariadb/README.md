...
docker run -d -p 3306:3306 -e MYSQL_ROOT_PASSWORD=rootpass ghcr.io/displace-technologies/mariadb:latest
...
docker run -d -p 3306:3306 \
  ...
  ghcr.io/displace-technologies/mariadb:latest
...
- `ghcr.io/displace-technologies/mariadb:latest` - Latest stable MariaDB
- `ghcr.io/displace-technologies/mariadb:11.5` - Specific version
- `ghcr.io/displace-technologies/mariadb:11` - Major version
