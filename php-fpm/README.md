...
- **PHP 8.4.13** (latest) - `ghcr.io/displace-technologies/php-fpm:latest`
- **PHP 8.3.26** - `ghcr.io/displace-technologies/php-fpm:8.3`
...
docker run -d -p 9000:9000 ghcr.io/displace-technologies/php-fpm:latest

# Run PHP-FPM 8.3
docker run -d -p 9000:9000 ghcr.io/displace-technologies/php-fpm:8.3

# Run with custom code
docker run -d -p 9000:9000 -v $(pwd):/var/www/html ghcr.io/displace-technologies/php-fpm:8.4
```
...
services:
  web:
    image: ghcr.io/displace-technologies/apache:latest
    ports:
      - "8080:80"
    volumes:
      - ./html:/var/www/html
  ...
  php:
    image: ghcr.io/displace-technologies/php-fpm:8.4
    volumes:
      - ./html:/var/www/html
```
...
docker run -d -p 9000:9000 \
  ...
  -v $(pwd):/var/www/html \
  ghcr.io/displace-technologies/php-fpm:8.4
```
...
- `ghcr.io/displace-technologies/php-fpm:latest` → PHP 8.4.13
- `ghcr.io/displace-technologies/php-fpm:8.4` → PHP 8.4.13
- `ghcr.io/displace-technologies/php-fpm:8.4.13` → PHP 8.4.13
- `ghcr.io/displace-technologies/php-fpm:8.3` → PHP 8.3.26
- `ghcr.io/displace-technologies/php-fpm:8.3.26` → PHP 8.3.26
